...
import '../view/attendance_form_view.dart';

class AttendanceFormController extends State<AttendanceFormView> {
  static late AttendanceFormController instance;
  late AttendanceFormView view;
